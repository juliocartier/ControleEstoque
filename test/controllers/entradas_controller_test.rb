...
class EntradasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create entrada" do
    assert_difference('Entrada.count') do
      post entradas_url, params: { entrada: { dataEntrada: @entrada.dataEntrada, descricao: @entrada.descricao, nome: @entrada.nome, unidade: @entrada.unidade, valorUnit: @entrada.valorUnit, valotTotal: @entrada.valotTotal } }
    end
  ...
  test "should update entrada" do
    patch entrada_url(@entrada), params: { entrada: { dataEntrada: @entrada.dataEntrada, descricao: @entrada.descricao, nome: @entrada.nome, unidade: @entrada.unidade, valorUnit: @entrada.valorUnit, valotTotal: @entrada.valotTotal } }
